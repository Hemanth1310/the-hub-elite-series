-- ============================================
-- ELITESERIE 2026 PREDICTIONS - DATABASE SCHEMA
-- Simplified MVP for Private Group (8-10 users)
-- ============================================
...
ON predictions(user_id, (
  SELECT round_id FROM matches WHERE id = match_id
))
...
-- ============================================
-- 8. ENFORCE SINGLE PUBLISHED ROUND (OPTIONAL)
-- ============================================

-- Optional trigger to ensure only one round is published at a time
...
-- ============================================
-- 9. TRIGGER FOR ROUND FINALIZATION
-- ============================================
...
-- ============================================
-- 10. ROW LEVEL SECURITY (OPTIONAL FOR MVP)
-- ============================================
...
-- Simple policies: authenticated users can read everything
...
-- Users can modify their own predictions
CREATE POLICY "users_own_predictions" ON predictions 
FOR ALL USING (auth.uid() = user_id);

-- ============================================
-- 11. SEED DATA - ELITESERIE TEAMS
-- ============================================
